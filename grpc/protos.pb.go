...
type FileInfo struct {
	...
	FullFilesize uint64 `protobuf:"varint,3,opt,name=fullFilesize,proto3" json:"fullFilesize,omitempty"`
}
...
func (x *FileInfo) GetFullFilesize() uint64 {
	if x != nil {
...
func (x *DownloadFileRequest) Reset() {
	*x = DownloadFileRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_protos_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DownloadFileRequest) Descriptor() ([]byte, []int) {
	return file_grpc_protos_proto_rawDescGZIP(), []int{6}
}
...
func (x *DownlaodFileRespose) Reset() {
	*x = DownlaodFileRespose{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_protos_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DownlaodFileRespose) Descriptor() ([]byte, []int) {
	return file_grpc_protos_proto_rawDescGZIP(), []int{7}
}
...
var file_grpc_protos_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x66, 0x75, 0x6c,
	...
	0x63, 0x68, 0x75, 0x6e, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x32, 0xd2, 0x01, 0x0a, 0x0e, 0x43, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x45, 0x0a, 0x0e,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x16,
	0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65,
	0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x30, 0x01, 0x12, 0x39, 0x0a, 0x0a, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x46, 0x69, 0x6c,
	...
	0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x3e,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x61, 0x6f, 0x64, 0x46,
	0x69, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x24,
	0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x79, 0x70,
	0x65, 0x72, 0x78, 0x70, 0x69, 0x7a, 0x7a, 0x61, 0x2f, 0x72, 0x70, 0x69, 0x43, 0x6c, 0x69, 0x2f,
...
var file_grpc_protos_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_grpc_protos_proto_goTypes = []interface{}{
	...
	(*DownlaodFileRespose)(nil),    // 7: DownlaodFileRespose
}
var file_grpc_protos_proto_depIdxs = []int32{
	...
	6, // 5: CommandService.DownloadFile:input_type -> DownloadFileRequest
	1, // 6: CommandService.ExecuteCommand:output_type -> ExecuteCommandResponse
	5, // 7: CommandService.UploadFile:output_type -> UploadFileResponse
	7, // 8: CommandService.DownloadFile:output_type -> DownlaodFileRespose
...
func file_grpc_protos_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grpc_protos_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_protos_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
...
type CommandServiceClient interface {
	...
	DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (CommandService_DownloadFileClient, error)
}
...
func (c *commandServiceClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (CommandService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CommandService_serviceDesc.Streams[2], "/CommandService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
	x := &commandServiceDownloadFileClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CommandService_DownloadFileClient interface {
	Recv() (*DownlaodFileRespose, error)
	grpc.ClientStream
}

type commandServiceDownloadFileClient struct {
	grpc.ClientStream
}

func (x *commandServiceDownloadFileClient) Recv() (*DownlaodFileRespose, error) {
...
type CommandServiceServer interface {
	...
	DownloadFile(*DownloadFileRequest, CommandService_DownloadFileServer) error
}
...
func (*UnimplementedCommandServiceServer) DownloadFile(*DownloadFileRequest, CommandService_DownloadFileServer) error {
...
func _CommandService_DownloadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DownloadFileRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CommandServiceServer).DownloadFile(m, &commandServiceDownloadFileServer{stream})
}

type CommandService_DownloadFileServer interface {
	Send(*DownlaodFileRespose) error
	grpc.ServerStream
}

type commandServiceDownloadFileServer struct {
	grpc.ServerStream
}

func (x *commandServiceDownloadFileServer) Send(m *DownlaodFileRespose) error {
	return x.ServerStream.SendMsg(m)
}
